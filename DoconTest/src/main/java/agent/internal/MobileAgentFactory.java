...
public class MobileAgentFactory {
	...
	private static void initCaps(Configuration config, DesiredCapabilities caps) {
		...
		caps.setCapability("newCommandTimeout", 36000);
	...
	private static void populatePlatformSpecificCaps(Configuration config, DesiredCapabilities caps) throws Exception {
		...
		case IOS:
			...
			caps.setCapability("newCommandTimeout", 520000);
//			caps.setCapability("bundleId", "com.docon.enterprise.vs");
...
//			caps.setCapability(MobileCapabilityType.PLATFORM_NAME, Platform.ANDROID);
			...
			caps.setCapability(MobileCapabilityType.AUTOMATION_NAME,config.getValue(ConfigType.ANDROID_AUTOMATION_NAME));
			caps.setCapability("autoGrantPermissions", true);
			break;
		case ANDROID_WEB:
